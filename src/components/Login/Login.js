...
import CustomSnackbar from "../shared/CustomerSnackbar";
import "./login.css";
  ...
  const handleLogin = async () => {
    try {
      ...
      if (error.code === "auth/invalid-credential") {
        ...
        setSnackbarMessage(
          "Too many incorrect attempts. Try again later or reset your password."
        );
      } else {
        setSnackbarMessage(
          "An error occurred during login. Please try after sometime."
        );
      }
